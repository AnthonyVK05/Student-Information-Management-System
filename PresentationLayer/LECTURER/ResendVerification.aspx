<%@ Page Language="C#" AutoEventWireup="true"
    ...
    Inherits="Student_Information_Management_System.Lecturer.ResendVerification" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Lecturer Email Verification</title>
...
<form id="form1" runat="server">
    ...
    <div class="login-card">
        ...
        <div class="login-subtitle">
            Enter your lecturer email to receive a new verification link
        </div>
