    ...
    public partial class ResendVerification : System.Web.UI.Page
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                if (!dr.Read())
                {
                    ShowError("No lecturer account found with this email.");
                    return;
                }
        ...
        private void SendVerificationEmail(string email, string username, string token)
        {
            string verifyUrl =
                ...
                ResolveUrl("~/PresentationLayer/Lecturer/VerifyEmail.aspx?token=" + token);
            ...
            mail.Body =
                "Dear " + username + ",<br/><br/>" +
                "Please click the link below to verify your SIMS lecturer account:<br/><br/>" +
